...
class Point(object):
    ...
    def move_to(self, x, y):
        ...
        self.total_travel = self.total_travel + self.get_distance_from(Point(x, y))
    ...
    def move_by(self,dx,dy):
        """ Moves this point by some dx and/ or dy """
        self.total_travel = self.total_travel + self.get_distance_from(Point(self.x + dx, self.y + dy))
    ...
    def get_number_of_moves_made(self):
        """ Returns the amount of times a point moves """
        return self.moves
    ...
    def get_distance_from_start(self):
        A = (self.x-self.startx)**2
        B = (self.y-self.starty)**2
        total_distance = (A+B)**(1/2)
    ...
    def halfway_to(self,Point2):
        newpt = Point((Point2.x + self.x)/2, (Point2.y + self.y)/2)
        return newpt
